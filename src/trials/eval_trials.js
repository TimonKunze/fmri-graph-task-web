    ...
    on_start: (trial) => {
      const copy = t({
        it: {
          ...
          consciousnessPrompt: "Hai risolto il compito in modo consapevole e deliberato oppure in modo intuitivo e poco consapevole?",
          consciousnessOptions: [
            "Del tutto consapevole/deliberato",
            "Abbastanza consapevole/deliberato",
            "Abbastanza intuitivo/poco consapevole",
            "Del tutto intuitivo/poco consapevole",
          ],
